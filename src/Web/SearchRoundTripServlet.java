...
/**
 * Servlet implementation class SearchRoundTripServlet
 */
public class SearchRoundTripServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List <FlightInformaiton> resultListTwo = fs.findOnewayFight(flight);
